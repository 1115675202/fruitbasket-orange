...
import com.example.spring.boot.zhaoyun.module.user.repository.UserMenuRepository;
...
class UserServiceTest {
	...
	void test1() {
//		userService.test();
//		User user = new User()("").setSex(1).setRealName("zhaoyun").setBirthday(LocalDate.now()).setIdCardNo("123");
